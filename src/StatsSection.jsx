...
const StatsShowcase = () => {
  ...
  return (
    <section className="w-full bg-white">
      {/* Stats */}
      <div className="max-w-7xl mx-auto py-18 px-6 md:px-12 flex flex-col md:flex-row justify-center items-center gap-25">
        {stats.map((stat, idx) => (
          <motion.div
            key={idx}
...
<p className="text-lg md:text-xl text-gray-400 font-medium">
  {stat.label}
      ...
      <div className="flex justify-center py-1 px-6 md:px-10 pb-16">
        <img
          src="https://5.imimg.com/data5/DS/DF/ZI/SELLER-37334244/birthday-event-planer--500x500.jpg" // example placeholder image
          alt="Showcase"
